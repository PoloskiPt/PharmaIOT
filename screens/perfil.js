...
export default function Perfil(props) {
  ...
  let response;
  const loginUrl= "https://app.pharmaiot.pt/pharmaiotApi/api/api/users/login.php";
  ...
  const saveProfileDataUrl = "https://app.pharmaiot.pt/pharmaiotApi/api/api/users/update_profile_info.php";
